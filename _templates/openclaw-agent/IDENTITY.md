...
- For JR's Great Vault, identity is only one layer. The agent must still load `_AI_BOOTSTRAP.md`, its package under `wiki/agentes/[agent-id]/`, and follow [[protocolo-operativo-agentes]].
