...
tags: [understanding-kids, staff, hr]
---

# UK — Personal completo
...
> ⚠️ **Corte 2026-08-13:** salieron **María José Velásquez Ramos** (último día 31-jul-2026, finiquito civil preparado) y **María Esther** ("decidió desaparecer", confirmado por JR). Las tablas de abajo aún las listan como activas. Ver [[proyectos/activos/understanding-kids/estado-2026-08]] y [[proyectos/activos/understanding-kids/contratos-laborales]].
> Inventario no sensible de expedientes Drive: [[proyectos/activos/understanding-kids/expedientes-staff-2026-05-14]].

## Planilla (sueldo)

| Nombre | Rol estimado | Estado |
|---|---|---|
| **Edith Melgar** | Admin / recepción Z14 (Q2,028–2,150 / quincena) | Activa |
| **Daniela Guzmán** | Nueva secretaria de sede CAES | Activa |
| **Aura Violeta Fajardo** (Aury) | Secretaria/admin CAES | **SALIÓ / renunció** (prestaciones pagadas 2026) |
| **Mónica Samayoa** | Directora | Activa (estructura de pago separada) |

## Servicios profesionales (terapeutas / contratistas)

| Nombre | Notas | Estado |
|---|---|---|
| Eva Bocel | Terapeuta de lenguaje especializada en autismo; **tiene expediente en Drive** | Activa |
| Alejandra Sotomayor | Terapeuta de lenguaje; **tiene expediente en Drive** | Activa |
| Ana Julissa | Terapeuta de lenguaje especializada en terapia de alimentación (dos cuentas registradas) | Activa |
| Isabel López | Terapeuta | **YA NO ESTÁ** |
| Lourdes Galindo | Terapeuta | **YA NO ESTÁ** |
...
- [ ] Normalizar nombres con/sin tildes en pagos.
- [ ] Confirmar nombre completo/variante de María José para ubicar expediente documental correcto.
- [x] Eva Bocel y Alejandra Sotomayor: **sí tienen carpeta de expediente en Drive** (confirmado 2026-05-14).
- [x] Felipe: **contratado externo, sin carpeta de expediente en Drive** (confirmado 2026-05-14).
- [ ] Actualizar corte cuando estén hechos los pagos de mayo 2026.

## Relacionado

- [[understanding-kids]] · [[monica]]
