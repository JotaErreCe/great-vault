...
tags: [understanding-kids, formacion, diplomados, talleres]
---

# UK — Formación (Diplomados, Talleres, Cursos)

> Línea de formación de [[understanding-kids]]: diplomados internacionales, talleres para padres y cursos. Segunda fuente de ingresos más grande de UK, a veces la primera.
> Fuente: Drive (hojas de diplomados, Administración Pagos, Resumen Mes).

## Diplomados activos/completados

### Diplomado Internacional en Autismo — "Comprender, Evaluar e Intervenir"
...
### Diplomado Internacional de Integración Sensorial — 2026
...
- **Ponentes y costos por sesión**:
  ...
  - Dra. Davinia García — $500 USD/sesión (5 sesiones)
  - Dra. Margarita Arango — $295 USD/sesión (1 sesión)
  - Ximena Carreto — $400 USD/sesión (3 sesiones)
- **Costo total de ponentes**: Q65,605 + $8,545 USD (~Q131,451 combinado a TC 7.7)
- **Primer pago a ponentes realizado**: $2,118 USD + Q5,000 (Andrea Orellana via transferencia)
- **Drive**: spreadsheet `2026 diplomado` con hojas: Cuentas 2026, Pagos realizados, Temario y fechas, Temario, hoja por ponente

---

## Talleres (histórico identificado)

### Taller Alimentación Terapéutica — Marycarmen Montoya
