...
IA("Comunicar a la IVE y a los organismos de fiscalización, supervisión o vigilancia respectivos", [
  ...
  "Mantener actualizada la información general de Propi ante la Superintendencia de Bancos a través de la IVE, comunicando cualquier modificación en la forma y plazo que esta establezca (quince días conforme a la práctica vigente)."])
...
RI("d) Terminación del contrato individual de trabajo: Esta será aplicable", " d) Terminación", "d) Terminación")
...
for _o,_n in [("Destruccion de Registros","Destrucción de Registros"),("PEP´s","PEP"),("Expuestos Politicamente","Expuestos Políticamente"),("automaticamente","automáticamente"),
              ...
              ("Proponer  programas","Proponer programas"),
