...
IA("ANEXO — DOCUMENTOS QUE INTEGRAN EL SISTEMA DE PREVENCIÓN", [
  "Los siguientes documentos desarrollan este Manual, son independientes de él y se aplican en su versión vigente aprobada por el nivel que determine el órgano de dirección superior, salvo la matriz de riesgo consolidada y su metodología, cuya aprobación y la de sus actualizaciones corresponde siempre al órgano de dirección superior (artículo 8 del Decreto 15-2026). En ningún caso pueden contradecir lo dispuesto en este Manual, el cual prevalece; toda contradicción se resolverá a favor del Manual y dará lugar a la corrección inmediata del documento complementario.",
...
RI("e informar los resultados de las acciones correctivas ordenadas por la Dirección Ejecutiva", "Dirección Ejecutiva", "órgano de dirección superior")
...
for _o,_n in [("Destruccion de Registros","Destrucción de Registros"),("PEP´s","PEP"),("Expuestos Politicamente","Expuestos Políticamente"),("automaticamente","automáticamente"),
              ...
              ("(Anexo V)","(formato incluido en el Anexo de documentos del Sistema)"),("sujeto obligado","Persona Obligada"),("Lavado de Activos y/o Financiamiento del Terrorismo","LD/FT/FPADM"),
              ...
              ("Proponer  programas","Proponer programas"),("Propi  podrá","Propi podrá"),("procederá el  Reporte","procederá el Reporte")]:
...
RI("Vinculación a actividades relacionadas al lavado de dinero y de Activos", "relacionadas al lavado de dinero y de Activos y/ Financiamiento al Terrorismo", "relacionadas con el LD/FT/FPADM")
