...
rl.insert_row_after("Creación del documento", ["01", "10-09-2026", "Todo", "Actualización integral al Decreto 15-2026; reestructuración como manual marco con documentos complementarios independientes"])
...
set_cell(_tbl, 1, 1, "José Roberto Castañeda Arriola"); set_cell(_tbl, 1, 2, "Asesor legal externo (AMC Legal)"); set_cell(_tbl, 1, 4, "10-09-2026")
...
IA("Su finalidad principal consiste en controlar, generar conciencia",
   ["Declaración de cumplimiento. Propi declara su compromiso de cumplir el Decreto 15-2026, su reglamentación y las disposiciones de la Superintendencia de Bancos a través de la IVE; de adoptar, ejecutar y mantener los programas, políticas, procedimientos y controles contenidos en este Manual y en sus documentos complementarios; de presentar los reportes y atender los requerimientos de la IVE en la forma y plazo establecidos; de conservar sus registros; de mantener la confidencialidad que la Ley impone; de capacitar a su personal y colaboradores; y de aplicar el régimen disciplinario a quien incumpla estas obligaciones.", "El presente Manual es el documento marco del Sistema Integral de Prevención de Propi. Las políticas, procedimientos, reglamentos, códigos y formatos que lo desarrollan son documentos complementarios independientes, se enumeran en el Anexo «Documentos que integran el Sistema de Prevención», se aplican en su versión vigente y en ningún caso pueden contradecir lo dispuesto en este Manual, el cual prevalece."])
...
IA("(vigente desde el 17 de septiembre de 2026).", [
  ...
  "El Decreto 15-2026 derogó la Ley Contra el Lavado de Dinero u Otros Activos (Decreto 67-2001) y la Ley para Prevenir y Reprimir el Financiamiento del Terrorismo (Decreto 58-2005) (artículo 126), y dispone que toda referencia a dichas leyes contenida en la legislación, reglamentos u otras disposiciones aplicables se entienda hecha a la Ley Integral (artículo 125). En congruencia con ello, y en tanto se actualizan, toda referencia a las leyes derogadas contenida en las políticas, procedimientos, formularios y demás documentos internos de Propi se entenderá hecha al Decreto 15-2026 y a su reglamentación."])
...
D("Compañeros de Vida: Personas que conviven")
D("Oficial de Cumplimiento: Es el funcionario nombrado por el Secretario Junta Directiva Único")
D("Financiamiento del Terrorismo (FD)")
...
D("Operaciones Reguladas: Toda operación o transacción de efectivo")
D("Operación Sospechosa o Irregular: Todas las operaciones poco usuales")
...
D("Intendencia de Verificación Especial: Oficina primaria adscrita")

# --- glosario en orden alfabético (definiciones reubicadas) ---
IA("Contrapartes: personas naturales o jurídicas con las cuales", ["Contratista y Proveedor del Estado: personas individuales o jurídicas que suscriben contratos bajo cualquier modalidad de adquisición pública o que se encuentran inscritas y precalificadas en el Registro General de Adquisiciones del Estado (artículo 2, literales d y h); dan lugar a medidas de debida diligencia adicionales (artículo 25, literal b).", "Cónyuge o conviviente: persona unida a la PEP por matrimonio o por unión de hecho, incluida la relación estable de convivencia aunque no esté formalizada.", "Debida diligencia del cliente (DDC): proceso de análisis conforme a las normas, políticas, procedimientos y controles de Propi que permite identificar, conocer y verificar la identidad de los clientes, de quienes actúan en su nombre y de sus beneficiarios finales, el propósito de la relación de negocios y las transacciones que realicen (artículo 2, literal e)."])
IA("Destruccion de Registros: Proceso mediante el cual", "Estructura jurídica: forma de integración o asociación de personas jurídicas o individuales constituida conforme a las leyes de Guatemala o de otra jurisdicción, sin importar su naturaleza, incluidos los fideicomisos y fundaciones, y aquellas que no hayan sido formalizadas como personas jurídicas (artículo 2, literal f).")
IA("Financiamiento de la Proliferación de Armas de Destrucción Masiva (FPADM): Provisión", "Financiamiento del Terrorismo (FT): conducta de quien, por el medio que fuere, directa o indirectamente, proporcione, provea, done, recolecte, transfiera, entregue, adquiera, posea, administre, negocie o gestione fondos, dinero, recursos económicos, activos o cualquier clase de bienes con la intención o a sabiendas de que serán utilizados, en todo o en parte, para el terrorismo, en los términos del artículo 78 del Decreto 15-2026.")
IA("Firma Electrónica Avanzada: Conjunto de datos", "Intendencia de Verificación Especial (IVE): intendencia que forma parte de la estructura orgánica de la Superintendencia de Bancos, encargada de la recepción y análisis de información y, cuando proceda, de la difusión de inteligencia financiera a las autoridades competentes, así como de la supervisión de las Personas Obligadas en materia LD/FT; ejerce sus funciones en el ámbito estrictamente administrativo (artículos 51 y 52 del Decreto 15-2026). La persecución penal corresponde al Ministerio Público.")
IA("Lavado de Dinero u Otros Activos (LD): conducta tipificada", "Oficial de Cumplimiento: funcionario o ejecutivo de alta gerencia, nombrado por el órgano de dirección superior de Propi junto con su suplente, encargado de vigilar el cumplimiento de los Programas de Prevención LD/FT/FPADM y de las obligaciones que establece el Decreto 15-2026, su reglamentación y demás disposiciones aplicables; es el único enlace entre Propi y la Superintendencia de Bancos a través de la IVE (artículo 16).")
IA("La condición de PEP se adquiere desde la toma legal", "Persona Obligada: persona individual o jurídica comprendida en el artículo 3 del Decreto 15-2026. Propi lo es en virtud de la literal c), numeral 1, romano i, de dicho artículo.")
IA("Proveedor: Persona natural o jurídica que abastecen", ["Relación de negocios: cualquier relación contractual, profesional, comercial o de servicios entre Propi y el cliente (artículo 2, literal j). Para Propi se inicia con la reserva del inmueble o con la firma del contrato de Alianza Comercial o del contrato que corresponda según la contraparte, y se entiende finalizada con el pago de la última comisión a la Sociedad.", "Reporte de Transacción Sospechosa (RTS): reporte que Propi, a través de su Oficial de Cumplimiento, remite con prontitud, de forma exclusiva y confidencial, a la Superintendencia de Bancos a través de la IVE respecto de toda transacción sospechosa (artículo 30).", "Riesgo LD/FT/FPADM: contingencia de pérdida, daño u otra consecuencia adversa a que está expuesta Propi de ser utilizada, directa o indirectamente, para actividades de lavado de dinero u otros activos, financiamiento del terrorismo o financiamiento de la proliferación de armas de destrucción masiva (artículo 2, literal k)."])
IA("Señales de alerta: Hechos, situaciones, eventos", ["Sospecha: apreciación razonada y documentada, basada en indicios objetivos o verificables, que genere motivos razonables para considerar una posible vinculación de una transacción con el LD/FT, sin que sea necesaria la certeza técnica o la prueba plena de la comisión de un ilícito (artículo 2, literal l).", "Transacción: toda operación financiera o comercial que implique la transferencia, adquisición, depósito, retiro, intercambio o administración de fondos, bienes, valores u otros activos, realizada por un cliente o por un tercero en su nombre, a través de Propi, siempre que genere un registro verificable, implique la movilización o disposición de activos y corresponda a los servicios regulados que presta (artículo 2, literal m).", "Transacción inusual: transacción, operación o acto que por su monto, características o frecuencia no se ajusta al perfil de riesgo del cliente, sin una justificación económica o legal razonable (artículo 2, literal n).", "Transacción sospechosa: transacción inusual, concluida o no, debidamente examinada y documentada por Propi que, tras analizarla y aplicar las medidas de debida diligencia, carece de fundamento económico o legal evidente y respecto de la cual Propi sospecha o tiene motivos razonables para sospechar que los fondos proceden o se destinan a una actividad delictiva o al financiamiento del terrorismo (artículo 2, literal o).", "Transacciones en efectivo sujetas a registro y reporte: toda transacción en efectivo, única o estructurada, que Propi reciba de sus clientes por un monto igual o mayor a diez mil dólares de los Estados Unidos de América (US$ 10,000.00) o su equivalente en moneda nacional o cualquier otra divisa, que debe registrarse diariamente y reportarse periódicamente a la IVE (artículo 31). Los umbrales aplicables a transacciones por otros medios se rigen por el Procedimiento de Reportes vigente."])

# ================= VI. ESTRUCTURA ORGANIZATIVA =================
R("a) Conocer las disposiciones que establece la Ley contra el Lavado de Dinero y de Activos",
  "a) Conocer las disposiciones del " + DEC + ", su reglamentación y las disposiciones que emita la Superintendencia de Bancos a través de la IVE, y observarlas en el desempeño de sus funciones.")
...
IA("Comunicar a la IVE y a los organismos de fiscalización, supervisión o vigilancia respectivos", [
  ...
  "Aprobar, a propuesta del Oficial de Cumplimiento, las políticas que desarrollan este Manual y la matriz de riesgo consolidada con su metodología.",
  "Velar por que, por medio del Oficial de Cumplimiento, se mantenga actualizada la información general de Propi ante la Superintendencia de Bancos a través de la IVE y se comunique cualquier modificación en la forma y plazo que esta establezca (quince días conforme a la práctica vigente)."])
R("Además, el Oficial de Cumplimiento no se dedicarán exclusivamente a las funciones como tales",
  "El Oficial de Cumplimiento titular y su suplente serán nombrados por el órgano de dirección superior o quien haga sus veces (artículo 16 del Decreto 15-2026); el suplente fungirá en caso de ausencia temporal del titular. El Oficial de Cumplimiento podrá ejercer otras funciones dentro de la entidad y ostentará un cargo de alta gerencia o de similar naturaleza. Las calidades, atribuciones mínimas y condiciones de ejercicio del titular y del suplente, así como la forma y plazo para informar a la IVE su designación, renuncia, remoción o sustitución, se sujetan a la reglamentación de la Ley. Mientras esta no disponga otra cosa, el nombramiento, la sustitución o la remoción del titular y del suplente se comunicarán a la IVE dentro de los diez (10) días hábiles siguientes, acompañando el currículum vitae respectivo, conforme a la práctica vigente.")
...
# (bloque "Responsabilidades del OC": se conserva; en la base limpia solo existe una copia)
RI("Además de las atribuciones establecidas en el artículo 22 de Reglamento", 'Además de las atribuciones establecidas en el artículo 22 de Reglamento de la Ley Contra el Lavado de Dinero u Otros Activos el Oficial de Cumplimiento deberá desarrollar las siguientes:',
...
RI("Organizar la capacitación del personal en los aspectos relacionados con la prevención",
   ...
   "y remitir a la Superintendencia de Bancos, a través de la IVE, el informe sobre dicha capacitación con la periodicidad y en la forma que esta establezca (semestral conforme a la práctica vigente)")
...
R("Se solicitará a todos los posibles clientes antes de establecer una vinculación con Propi",
  "Antes de establecer la relación de negocios, todo posible cliente deberá proporcionar la información de identificación requerida (identidad, razón social o denominación, edad, ocupación u objeto social, estado civil, domicilio, nacionalidad, personería, capacidad legal y representación; y, tratándose de personas extranjeras, la comprobación de su ingreso y permanencia legal en el país, su condición migratoria y, cuando no sean residentes, la identificación de quien las representará legalmente) y completar el Formulario Conoce a tu Cliente y el formulario de creación de expediente que establezca la IVE, cualquiera que sea el nivel de debida diligencia aplicable, por medio de la herramienta tecnológica que designe el Oficial de Cumplimiento. Toda la información y su documentación de respaldo será revisada y aprobada por el Oficial de Cumplimiento.")
IA("Antes de establecer la relación de negocios, todo posible cliente deberá proporcionar", [
  ...
  "Inicio de la relación de negocios y momento de la verificación (artículo 22). Para el cliente comprador de un inmueble, la relación de negocios se inicia al momento de la reserva, con independencia de que el pago se realice después; para las desarrolladoras, corredores externos, proveedores y demás contrapartes, con la firma del contrato de Alianza Comercial o del contrato que corresponda. La identificación del cliente y de su beneficiario final y el cruce en listas deben completarse antes de que Propi habilite la reserva o entregue al cliente el número de cuenta para el pago. La verificación de la información se efectúa al inicio de la relación de negocios o al realizar transacciones para clientes ocasionales.",
  "Diferimiento de la verificación. Propi no difiere la verificación de la información del cliente, de quien actúe en su nombre ni del beneficiario final: la identificación, la verificación y el cruce en listas se completan antes de habilitar la reserva o de entregar el número de cuenta para el pago, y ninguna relación de negocios se establece sin el dictamen del Oficial de Cumplimiento. En consecuencia, Propi no adopta los supuestos de verificación posterior que permite el artículo 22 del Decreto 15-2026; cualquier cambio a esta política requerirá incorporar previamente en este Manual los supuestos tasados en que procedería el diferimiento, conforme a dicho artículo.",
  "Abstención y terminación. Propi se abstendrá de establecer relaciones de negocios o de ejecutar operaciones cuando le sea imposible aplicar las medidas de debida diligencia. Cuando la imposibilidad surja durante la relación de negocios, Propi le pondrá fin y el Oficial de Cumplimiento practicará y documentará un examen para determinar si procede un Reporte de Transacción Sospechosa (artículo 22). Los contratos con clientes y contrapartes incorporarán una manifestación de que Propi es Persona Obligada ante la Superintendencia de Bancos a través de la IVE conforme al Decreto 15-2026, y una cláusula de terminación por incumplimiento de los requerimientos de cumplimiento normativo.",
...
R("Se consideran de alto riesgo las personas naturales o jurídicas que el monto total de los ingresos recibidos sobrepase los USD $10,000.00",
  "Se consideran de riesgo alto los clientes que así resulten clasificados conforme a la matriz de riesgo y a la Política de Conocimiento del Cliente y, en todo caso, las Personas Expuestas Políticamente y sus personas vinculadas. Los clientes comprendidos en las demás situaciones especiales del artículo 25 del Decreto 15-2026 quedan sujetos a las medidas de debida diligencia adicionales de la Política de Debida Diligencia Reforzada, con la clasificación de riesgo que resulte de la matriz.")
...
R("Obtener la aprobación por escrito de la Asamblea de Accionista para establecer o continuar relaciones comerciales.",
  "Obtener la autorización del Oficial de Cumplimiento, o de quien designen el Consejo de Administración o la Asamblea General de Accionistas, para establecer o continuar relaciones de negocios de riesgo alto, en los términos previstos para los clientes PEP.", exact=True)
...
IA("Curriculum Vitae.", "Referencias laborales y personales por escrito.", exact=True)
IA("Información de contactos.", "Declaración patrimonial, cuando el puesto lo amerite conforme a la política de recursos humanos.", exact=True)
IA("Otros documentos para la contratación que el departamento de Recursos Humanos considere pertinentes",
   "Propi verificará contra documentos originales la identificación y los estudios del candidato y confirmará las referencias laborales y personales presentadas, dejando constancia en el expediente de las fuentes consultadas, los resultados obtenidos y la conclusión. El procedimiento de reclutamiento, selección y contratación se desarrolla en la política de recursos humanos y en el Reglamento Interno de Trabajo.",
   style_from="Adicionalmente, previo a cualquier contratación o en cualquier momento de la relación laboral")
# ================= IX. PROVEEDORES =================
...
R("De igual forma, procederá el  Reporte de tentativa de operación sospechosa",
  "De igual forma, procederá el Reporte de tentativa de transacción sospechosa cuando se tenga conocimiento de que una persona individual o jurídica, sea cliente o no, pretenda realizar una transacción inusual o no justificada que se infiera relacionada con el LD/FT/FPADM y que no se perfecciona porque quien intenta llevarla a cabo desiste de ella o porque los controles establecidos por Propi no permitieron o impidieron su realización. Estas situaciones se reportarán a la IVE como transacción sospechosa no concluida (tentativa), utilizando el formulario y los medios que esta defina (artículo 29 del Decreto 15-2026, transacción inusual «concluida o no»).")
...
IA("El riesgo de LDA/FT/FPADM se materializa a través de los riesgos asociados", [
  ...
  "La matriz de riesgo consolidada de Propi, con sus segmentos (clientes, desarrolladoras, corredores externos, proveedores y empleados), variables y metodología de calificación (probabilidad, impacto, nivel de riesgo y frecuencia de monitoreo), se incorpora como Anexo de este Manual y se actualiza conforme a lo previsto en esta sección sin necesidad de modificar el cuerpo del Manual."])
IA("La matriz de riesgo consolidada de Propi, con sus segmentos", [
  "Eventos de riesgo identificados por factor (artículo 9 del Decreto 15-2026), cuya calificación, controles y frecuencia de monitoreo constan en la matriz de riesgo consolidada:",
  "Factor clientes: vinculación del cliente, de su beneficiario final o de la contraparte con actividades de LD/FT/FPADM; información falsa, inexacta o insuficiente proporcionada por el cliente; clientes PEP o comprendidos en las situaciones especiales del artículo 25.",
  "Factor ubicación geográfica: clientes, fondos, beneficiarios finales o contrapartes vinculados a países o jurisdicciones de alto riesgo según el GAFI o sujetos a sanciones del Consejo de Seguridad de las Naciones Unidas.",
  "Factor canales de distribución y tecnología: relaciones y transacciones sin presencia física de las partes y uso de la plataforma tecnológica que favorezcan el anonimato; ciberataques que comprometan la integridad o confidencialidad de los expedientes y de la información de las transacciones.",
  "Factor bienes, productos y servicios: operaciones inmobiliarias de alto valor; pagos en efectivo o provenientes del exterior; adquisición de inmuebles por medio de estructuras jurídicas o interpósitas personas; modalidades de cobro por cuenta de terceros.",
  "Eventos operativos del sistema de prevención: omisión o aplicación incompleta de la debida diligencia; análisis incorrecto por información errónea; monitoreo inadecuado o falta de información oportuna para decidir; incumplimiento de los plazos de reporte."])
rl.delete_range("Riesgos Externos:", "Análisis incorrecto por información proporcionada errónea")
D("En la siguiente matriz de riesgos, la probabilidad de que ocurra cada riesgo se clasifica en una escala del 1 al 5")
...
R("El Oficial de Cumplimiento será la responsable de custodia del documento original",
  "El Oficial de Cumplimiento será responsable de la custodia del documento original y de su administración, y estará facultado para proponer cambios, modificaciones y actualizaciones, las cuales deberán ser aprobadas por el órgano de dirección superior (artículo 12 del Decreto 15-2026). Las políticas, procedimientos, formatos y demás documentos complementarios que integran el Sistema de Prevención son documentos independientes: el Oficial de Cumplimiento propondrá su emisión y actualización; las políticas y la matriz de riesgo consolidada con su metodología serán aprobadas por el órgano de dirección superior, y los procedimientos, manuales de procedimiento operativo y formatos por el Oficial de Cumplimiento con el visto bueno de la gerencia general, sin que ello requiera modificar este Manual, siempre que no lo contradigan; en caso de conflicto prevalece el Manual. La divulgación de este Manual y de sus documentos complementarios al personal será responsabilidad del Oficial de Cumplimiento en coordinación con Recursos Humanos, o quien ejecute funciones similares. El Oficial de Cumplimiento remitirá a la Superintendencia de Bancos, a través de la Intendencia de Verificación Especial, por el Portal de Personas Obligadas, el presente Manual aprobado y cada una de sus actualizaciones, a más tardar dentro del mes calendario siguiente a su aprobación, salvo que la reglamentación del Decreto 15-2026 o la IVE dispongan una forma o plazo distintos.")
...
IA("ANEXO — DOCUMENTOS QUE INTEGRAN EL SISTEMA DE PREVENCIÓN", [
  "Los siguientes documentos desarrollan este Manual, son independientes de él y se aplican en su versión vigente. Las políticas y la matriz de riesgo consolidada con su metodología son aprobadas por el órgano de dirección superior (artículos 8 y 12 del Decreto 15-2026); los procedimientos, manuales de procedimiento operativo y formatos, por el Oficial de Cumplimiento con el visto bueno de la gerencia general. En ningún caso pueden contradecir lo dispuesto en este Manual, el cual prevalece; toda contradicción se resolverá a favor del Manual y dará lugar a la corrección inmediata del documento complementario.",
  "1. Política de Identificación y Verificación del Beneficiario Final.",
  "2. Política de Personas Expuestas Políticamente, incluida la debida diligencia para clientes PEP y sus personas vinculadas.",
  "3. Política de Conocimiento del Cliente (KYC), incluidas la debida diligencia simplificada y la estándar, la documentación mínima por tipo de cliente y los parámetros de valor y perfil para la asignación del nivel de diligencia.",
  ...
  "6. Matriz de riesgo consolidada y su metodología (Anexo de este Manual; aprobación reservada al órgano de dirección superior).",
  ...
  "12. Reglamento Interno de Trabajo y política de recursos humanos (reclutamiento, selección y contratación).",
  "13. Código de Ética.",
  "14. Formatos: Declaración Jurada de Beneficiario Final; Declaración Jurada de Persona Expuesta Políticamente; formulario de creación de expediente del cliente establecido por la IVE (IVE-RE-23 o el que lo sustituya); Formulario Conoce a tu Cliente; Formulario Conoce a tu Proveedor; Formulario de Reporte Interno; Lista de Asistencia de Capacitación; texto modelo de comunicación de rechazo o terminación.",
  "15. Cláusulas contractuales modelo: manifestación de Persona Obligada, terminación por incumplimiento de los requerimientos de cumplimiento normativo y colaboración con la IVE.",
...
# ================= CORRECCIONES DE VERIFICACIÓN (2026-09-08) =================
RI("e informar los resultados de las acciones correctivas ordenadas por la Dirección Ejecutiva", "la Dirección Ejecutiva", "el órgano de dirección superior")
RI("Personas Expuestas Políticamente Nacionales: se entenderán como PEP nacionales",
   "que desempeñan o han desempeñado funciones públicas en nuestro país o en el extranjero.",
   "que desempeñan o han desempeñado cargos públicos prominentes, conforme a la resolución anual de la Superintendencia de Bancos prevista en el artículo 2, literal g), del Decreto 15-2026.")
R("En el proceso de vinculación de los posibles clientes PEP tiene un de riesgo medio o alto",
  "Los posibles clientes que sean Personas Expuestas Políticamente, así como sus personas vinculadas, se clasifican en riesgo alto y quedan sujetos a debida diligencia intensificada (artículo 25, literal a, del Decreto 15-2026). Con el fin de cumplir con la normativa vigente y con los estándares internacionales sobre prevención del LD/FT/FPADM, Propi establece el siguiente mecanismo de identificación de Personas Expuestas Políticamente -PEP- y personas vinculadas:")
rl.replace_token("a travéss", "a través")
RI("El nombramiento del Oficial de Cumplimiento no exime a los demás empleados", "Lavado de Activos y Financiamiento del Terrorismo", "LD/FT/FPADM")
RI("deberá recibir la inducción sobre prevención de Lavado de Activos y Financiamiento al Terrorismo", "Lavado de Activos y Financiamiento al Terrorismo", "LD/FT/FPADM")

# ================= FONDO/FORMA PASADA 1 (antes de los tokens) =================
RI("establecer canales de comunicación y cooperación con los Oficiales de Cumplimiento de otras entidades", "garantizando la confidencialidad de la información conforme a la Ley", "garantizando la confidencialidad de la información conforme a la Ley.")
R("Verificar listados relacionados con personas naturales",
  "Verificar listados relacionados con personas individuales que desempeñan o han desempeñado cargos públicos prominentes en el país o en el extranjero (PEP), previo a establecer o iniciar cualquier negocio con clientes potenciales y durante la continuación de la relación comercial. Las listas de PEP serán revisadas periódicamente para garantizar que la información utilizada esté vigente y completa. Identificación de personas vinculadas: los posibles clientes deberán completar el Formulario Conoce a tu Cliente por medio de la herramienta tecnológica que designe el Oficial de Cumplimiento, la cual realiza una verificación por nombre en las listas de cautela y muestra una alerta automáticamente en caso de haber alguna coincidencia.")
R("Las personas que en el proceso de vinculación se identifiquen que son Expuestos",
  "Las personas que en el proceso de vinculación se identifiquen como Personas Expuestas Políticamente o como personas vinculadas a una PEP deberán presentar, además de la documentación exigida por la debida diligencia intensificada, la documentación adicional que establezca el Oficial de Cumplimiento.")
RI("qué relación ostenta con la cuenta que utilizará para realizar transacciones", "qué relación ostenta con la cuenta que utilizará para realizar transacciones", "el origen de los fondos o la titularidad de la cuenta bancaria desde la cual realizará los pagos")
RI("el documento de procedencia u origen de fondos", "Propi  podrá solicitar", "Propi podrá solicitar")
RI("se incluirán en la Lista de Control que corresponda", "en la Lista de Control que corresponda", "en la Lista de Control interna de personas no aceptadas, que administra el Oficial de Cumplimiento")
RI("Propi conformará un expediente para cada proveedor", "relación de negocio con Propi", "relación de negocio con Propi.")
IA("Propi conformará un expediente para cada proveedor",
   "Los contratos con proveedores de servicios que participen en la operación de Propi incluirán su obligación de colaborar con la Superintendencia de Bancos, a través de la IVE, cuando esta lo requiera, en los términos del artículo 35 del Decreto 15-2026.")
RI("Para ambos casos, se deberá dejar constancia de todos los análisis", "enviado a la Superintendencia de Bancos o a la IVE", "enviado a la Superintendencia de Bancos a través de la IVE.")
R("De acuerdo a la colorimetría, así deberá ser el plazo del monitoreo:", "De acuerdo con la colorimetría de la matriz, el plazo mínimo de monitoreo será:", exact=True)
RI("es necesario crear y fomentar una cultura prevención", "cultura prevención", "cultura de prevención")
RI("b) Amonestación escrita. Esta será aplicable", " b) Amonestación escrita", "b) Amonestación escrita")
R("d) Terminación del contrato individual de trabajo: Esta será aplicable",
  "d) Terminación del contrato individual de trabajo. Esta será aplicable cuando la falta de cumplimiento sea considerada muy grave o cuando, luego de una suspensión, el empleado reincida en los incumplimientos, conforme al Reglamento Interno de Trabajo y al Código de Trabajo, previa recomendación del Oficial de Cumplimiento.")

# ================= FONDO/FORMA PASADA 2 =================
R("Los clientes considerados de alto riesgo incrementan el grado de exposición",
  "Los clientes considerados de alto riesgo incrementan el grado de exposición de Propi al Riesgo LD/FT/FPADM; por ello, las medidas de debida diligencia deben intensificarse a fin de comprender claramente sus transacciones y mantener un monitoreo continuo que permita detectar actividades inusuales y mitigar los riesgos que puedan afectar a Propi.")
RI("Personas Expuestas Políticamente Extranjeras: se entenderán por PEPs Extranjeras",
   "individuos que cumplen o a quienes se les han confiado funciones públicas prominentes en este o en otro país.",
   "las personas individuales que desempeñan o han desempeñado cargos públicos prominentes en otro país, o a quienes se les ha confiado una función prominente en una organización internacional.")
RI("Propi evaluará el riesgo basado en la función del cargo",
   "De igual manera será considerado el factor de riesgo como jurisdicciones de alto riesgo, naturaleza de la relación de negocios, transacciones inusuales y el volumen esperado de operaciones.",
   "De igual manera se considerarán como factores de riesgo las jurisdicciones de alto riesgo, la naturaleza de la relación de negocios, las transacciones inusuales y el volumen esperado de operaciones.")
R("Analizar e implementar las medidas correctivas derivadas de las observaciones detectadas",
  "Analizar e implementar las medidas correctivas derivadas de las observaciones de la auditoría interna, o de quien realice funciones similares, y de la auditoría externa, relacionadas con la prevención del LD/FT/FPADM.")
RI("Propi, establece que el cumplimiento de las medidas aprobadas para el conocimiento del cliente",
   "Propi, establece que el cumplimiento", "Propi establece que el cumplimiento")

RI("Propi en cumplimiento a lo establecido en la normativa nacional vigente", "deberá de nombrar", "deberá nombrar")
R("En la debida diligencia intensificada, será necesario requerir a clientes de alto riesgo",
  "En la debida diligencia intensificada será necesario requerir a los clientes de alto riesgo medidas adicionales a las de la debida diligencia estándar, verificando cuidadosamente la documentación presentada. Propi debe cumplir con las obligaciones de debida diligencia intensificada en los casos de aumento del Riesgo LD/FT/FPADM.")

R("La auditoría interna, o quien ejecute funciones similares dentro de Propi deberá elaborar y ejecutar de forma anual",
  "La auditoría interna, o quien ejecute funciones similares dentro de Propi, deberá elaborar y ejecutar anualmente un programa de revisión interna del Programa de Prevención LD/FT/FPADM, en el cual se evaluará el cumplimiento y la efectividad de la ejecución de las políticas y procedimientos establecidos en el presente Manual, en sus documentos complementarios y en la regulación vigente (artículo 15 del Decreto 15-2026).")
# ================= ÚLTIMA REVISIÓN (2026-09-10) =================
R("Comunicar a la IVE y a los organismos de fiscalización, supervisión o vigilancia respectivos",
  "Velar por que, por medio del Oficial de Cumplimiento, se comuniquen a la IVE, en la forma y plazo que esta establezca, la designación, renuncia, remoción o sustitución del Oficial de Cumplimiento titular y suplente (artículo 16 del Decreto 15-2026).")
D("Seleccionar al Oficial de Cumplimiento y al suplente.", exact=True)
R("Nombrar el Oficial de Cumplimiento y su Suplente.", "Seleccionar y nombrar al Oficial de Cumplimiento titular y a su suplente (artículo 16 del Decreto 15-2026).", exact=True)
R("Establecer la responsabilidad del Oficial y del suplente de Cumplimiento",
  "Establecer la responsabilidad del Oficial de Cumplimiento y de su suplente, del personal de auditoría interna o de quien realice funciones similares relacionadas con la prevención del LD/FT/FPADM, del personal de las áreas generadoras de negocio y de atención de clientes, así como del resto de los empleados y colaboradores de Propi.")
RI("Realizar informes trimestrales al órgano de administración", "órgano de administración", "órgano de dirección superior")
R("Elaboración de metodologías, indicadores cualitativos y cuantitativos", "Elaborar metodologías e indicadores cualitativos y cuantitativos para la detección oportuna de transacciones inusuales.")
IA("En el caso que algún Cliente de riesgo se encuentre bajo alguna de las causales anteriores",
   "Cuando la coincidencia sea con las listas emitidas por el Consejo de Seguridad de las Naciones Unidas, se aplicará además, de inmediato, el procedimiento de limitación preventiva y comunicación al Ministerio Público previsto en este Manual (artículo 43 del Decreto 15-2026).")
R("La política de conozca a su proveedor consiste en mejorar los canales de comunicación",
  "La Política de Conocimiento de Proveedores tiene por finalidad estandarizar los métodos internos de control y evaluación de los proveedores de Propi, a fin de mitigar su exposición al Riesgo LD/FT/FPADM.")
RI("Archivo o Registro: Conjunto de datos", "Registro: Conjunto", "Registro: conjunto")
RI("Firma Electrónica Avanzada: Conjunto de datos", "Avanzada: Conjunto", "Avanzada: conjunto")
RI("(FPADM): Provisión de recursos", "(FPADM): Provisión", "(FPADM): provisión")
RI("Señales de alerta: Hechos, situaciones", "alerta: Hechos", "alerta: hechos")
RI("Armas de Destrucción Masiva: de conformidad a la resolución", "de conformidad a la resolución", "de conformidad con la resolución")
RI("Proliferación de Armas de Destrucción Masiva: es todo acto", "químicas o biológicas, sus medios de lanzamiento", "químicas o biológicas, o de sus medios de lanzamiento")
R("Destruccion de Registros: Proceso mediante", "Destrucción de Registros: proceso mediante el cual se elimina de manera definitiva la información almacenada en los archivos, tanto en formato físico como electrónico, tras cumplir con los requisitos de tiempo y relevancia establecidos.")
R("Proveedor: Persona natural o jurídica que abastecen", "Proveedor: persona individual o jurídica que abastece de productos o servicios a Propi.")

# ================= REVISIÓN DE FORMA (2026-09-08) =================
for _o,_n in [("Destruccion de Registros","Destrucción de Registros"),("PEP´s","PEP"),("Expuestos Politicamente","Expuestos Políticamente"),("automaticamente","automáticamente"),
              ("presente Manua de cumplimiento","presente Manual de cumplimiento"),("funcionaros","funcionarios"),("contraído o subcontratado","contratado o subcontratado"),
              ("una solo plataforma","una sola plataforma"),("Antecedentes Antecedentes","Antecedentes"),("que abastecen","que abastece"),("Organización International","Organización Internacional"),
              ("(Anexo V)","(formato incluido en el Anexo de documentos del Sistema)"),("del sujeto obligado","de la Persona Obligada"),("sujeto obligado","Persona Obligada"),("especialmente en al Oficial","especialmente al Oficial"),("PEPs Extranjeras","PEP extranjeras"),("Lavado de Activos y/o Financiamiento del Terrorismo","LD/FT/FPADM"),
              ("Lavado de Activos y/o canalización","Lavado de Dinero u Otros Activos y/o canalización"),("lavado de activos, al logro","LD/FT/FPADM, al logro"),
              ("Lavado de Activos y Financiación del Terrorismo","LD/FT/FPADM"),("POLITICAS","POLÍTICAS"),("AUDITORIA EXTERNA","AUDITORÍA EXTERNA"),
              ("personas naturales","personas individuales"),("Proponer  programas","Proponer programas"),
              ("por medio de la política conoce tu cliente, los procedimientos","por medio de la Política de Conocimiento del Cliente, los procedimientos"),
              ("lavado de dinero, otros activos y financiamiento del terrorismo","LD/FT/FPADM"),("lavado de dinero, otros activos o financiamiento del terrorismo (LD/FT/FPADM)","LD/FT/FPADM"),
              ("lavado de dinero y financiamiento del terrorismo","LD/FT/FPADM"),("operaciones sospechosas y reguladas","transacciones sospechosas y en efectivo"),
              ("operaciones inusuales","transacciones inusuales"),("operaciones sospechosas","transacciones sospechosas"),("operación inusual determinada como sospechosa","transacción inusual determinada como sospechosa"),
              ("por los socios o contrapartes","por los clientes o contrapartes"),("beneficiarios finales o reales","beneficiarios finales"),("Propi, debe cumplir","Propi debe cumplir"),
              ("últimos dos ejercicios fiscales","últimos dos ejercicios fiscales."),("En el caso que algún Cliente de riesgo se encuentre","En caso de que algún cliente se encuentre"),
              ("personal temporal, o subcontratos","personal temporal o subcontratado"),("en el cual deberá registrar todos los análisis","en las cuales deberá registrar todos los análisis"),
              ("prácticas que conforman el Manual de cumplimiento del Sistema Integral de Prevención contra el LD/FT/FPADM","prácticas que conforman este Manual"),("presente Manual de cumplimiento","presente Manual"),
              ("debe de cubrir","debe cubrir"),("deberá de verificar al candidato","deberá verificar al candidato"),("conceptos fundamentales de LD/FT/FPADM,","conceptos fundamentales de LD/FT/FPADM;"),("para la prevención de LD/FT/FPADM,","para la prevención de LD/FT/FPADM;"),
              ("deberá de quedar documentada","deberá quedar documentada"),("los Diplomas de participación","los diplomas de participación"),("deberá de guardarse","deberá guardarse"),
              ("presente manual y demás normativa","presente Manual y demás normativa"),("presente manual, políticas o procedimientos","presente Manual, políticas o procedimientos"),
              ("El presente manual o sus modificaciones","El presente Manual o sus modificaciones"),("Diseñar el presente manual de cumplimiento","Diseñar el presente Manual"),("Propi  podrá","Propi podrá"),("procederá el  Reporte","procederá el Reporte")]:
    print("  forma", repr(_o), "->", rl.replace_token(_o,_n))
RI("Dado a la naturaleza de la información que se maneja en, se debe", "Dado a la naturaleza de la información que se maneja en, se debe", "Dada la naturaleza de la información que se maneja, se debe")
R("Debida Diligencia simplificada.", "Debida Diligencia simplificada", exact=True)
R("Proceso para la Identificación de un PEP.", "Proceso para la Identificación de un PEP", exact=True)
R("Aplicación", "Aplicación de las políticas y procedimientos para la prevención del LD/FT/FPADM;")   # párrafo con tabuladores entre palabras
# índice de tablas: ya no hay leyendas; se elimina el título "Tablas" y las entradas del campo
import re as _re
D("Tablas", exact=True)
for _p in rl._toc:
    if _re.match(r"Tabla \d", rl.ptext(_p)): rl._del_all_runs(_p); rl._mark_para_deleted(_p)

IA("El Oficial de Cumplimiento recibirá las solicitudes de información que realice la Superintendencia de Bancos",
   "Propi queda sujeta a la supervisión y verificación de la Superintendencia de Bancos a través de la Intendencia de Verificación Especial (artículos 51 y 52 del Decreto 15-2026) y facilitará las visitas, inspecciones y requerimientos que esta realice.")
