...
ROWS=[  # (Área, Riesgo, Prob, Cons, Medidas de control)  — orden: probabilidad ascendente, consecuencia A→E
 ...
 ("1, 2 y 3","Cobro de comisiones de Propi desde cuentas de terceros distintos del obligado al pago, en efectivo o sin factura","3","B","Facturación vinculada al contrato; pago únicamente por transferencia desde una cuenta a nombre del obligado al pago —desarrolladora, propietario, inquilino o comprador, según la línea de negocio—; alerta al Oficial de Cumplimiento ante cualquier tercero."),
 ...
 ("2","Pago de la reserva en efectivo o desde cuentas de terceros no identificados","4","B","Prohibición de efectivo; el comprobante debe estar a nombre del cliente; validación del expediente conforme a la lista de verificación antes de habilitar la reserva y de entregar el número de cuenta, y autorización del Oficial de Cumplimiento cuando el cliente sea PEP o de riesgo alto."),
 ("1, 2 y 3","Falsificación o alteración de documentos de identidad, de propiedad o de respaldo del origen de fondos","4","B","Verificación documental contra originales y fuentes independientes; expediente completo antes de la reserva y autorización del Oficial de Cumplimiento en los casos de PEP o riesgo alto."),
 ...
 ("2","Expedientes incompletos o formularios de la IVE sin completar o sin firma en la precalificación","4","C","Revisión del expediente completo conforme a la lista de verificación antes de habilitar la reserva o entregar el número de cuenta; revisión por muestreo del Oficial de Cumplimiento y autorización previa en los casos de PEP o riesgo alto."),
 ("3","Sobrevaloración o subvaloración de propiedades","4","C","Revisión de avalúos y monitoreo de precios de mercado."),
 ("2 y 3","Compra con fondos propios sin financiamiento bancario, o sin justificación del origen de los fondos","5","A","Debida diligencia intensificada: declaraciones de ISR e IVA, estados de cuenta y documentación del origen de los fondos; autorización del Oficial de Cumplimiento antes de la promesa y de la escrituración."),
 ...
 ("1, 2 y 3","Vinculación o continuidad de la relación con clientes, beneficiarios finales o contrapartes designados en las listas del Consejo de Seguridad de las Naciones Unidas","2","A","Cruce en listas antes de la vinculación y monitoreo permanente; ante coincidencia confirmada, limitación preventiva, aviso al Ministerio Público dentro de 24 horas y RTS a la IVE."),
 ("1, 2 y 3","Ciberataque o acceso no autorizado que comprometa la integridad o la confidencialidad de los expedientes y de la información de las transacciones","3","B","Controles de acceso por perfil, respaldo periódico y registro de accesos; aviso inmediato al Oficial de Cumplimiento; conservación conforme a la política de archivo."),
 ("1, 2 y 3","Omisión o aplicación incompleta de la debida diligencia en la vinculación o durante la relación","3","B","Lista de verificación del expediente; revisión por muestreo del Oficial de Cumplimiento; capacitación anual y prueba de conocimientos."),
 ("1, 2 y 3","Análisis incorrecto de una operación por información errónea o incompleta","3","C","Verificación contra fuentes independientes y documentación del examen; revisión del Oficial de Cumplimiento en los casos de riesgo alto."),
 ("1, 2 y 3","Monitoreo inadecuado o falta de información oportuna para decidir sobre una transacción inusual","3","C","Señales de alerta y escenarios definidos por el Oficial de Cumplimiento; reporte interno de transacciones inusuales; tablero de monitoreo."),
 ("1, 2 y 3","Incumplimiento de los plazos de reporte a la IVE o al Ministerio Público","4","B","Calendario de reportes con responsable y plazos internos; archivo del acuse de recibo; verificación muestral en la evaluación anual."),
]
