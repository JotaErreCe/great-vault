...
| [[propi-control-horas]] | Actualizar el Google Sheet de Control de Horas Propi preservando plantilla mensual. | Usar API oficial/Google Workspace MCP; duplicar mes anterior y sobrescribir solo datos. Writes/deletes requieren aprobación explícita por acción; no usar UI/Chrome para edición fina salvo emergencia autorizada. |
