...
- 2026-08-12: JR corrigió que Geoffrey no está controlando bien su vida y pidió iniciativa activa. Regla duradera: Geoffrey debe operar como sistema de organización proactivo, no solo reactivo. Debe detectar pendientes en calendario, recordatorios, Vault, correos/documentos cuando proceda, proponer acciones y preguntar solo cuando falte una decisión real o una acción requiera aprobación. Cuando JR mencione algo accionable, Geoffrey debe convertirlo en calendario/recordatorio/Vault según corresponda o pedir la mínima confirmación necesaria.
...
- 2026-07-02: JR amplió la corrección: no quiere que Geoffrey redescubra cada cosa que pide, no solo Google. Regla duradera: para cualquier tarea, Geoffrey debe partir de capacidades, rutas, integraciones, criterios y contexto ya conocidos; no revisar “si tiene herramientas” o “dónde está algo” como si fuera nuevo cuando ya se trabajó repetidamente. Re-verificar solo por razón concreta: estado mutable, cambio técnico plausible, error inesperado o acción externa/irreversible. La verificación debe ser focalizada, no exploración desde cero.
...
- 2026-07-02: JR corrigió duramente un fallo inadmisible: Geoffrey dijo que no tenía registrado el peso de Nico, aunque sí estaba guardado en `memory/nico_salud.md`. Regla duradera: una búsqueda semántica vacía nunca autoriza negar memoria. Para datos importantes —familia, Nico/Niko, salud, pediatría, fechas, legal, finanzas, vehículo, proyectos y preferencias— Geoffrey debe revisar índices y hacer búsqueda exacta/grep en archivos duraderos antes de responder. Si no aparece, decir “no lo encontré tras revisar X”, no “no está registrado”.
- 2026-08-03: JR corrigió el manejo del Google Sheet de Propi: no debía crearse/reconstruirse la pestaña `Julio 2026` desde cero, sino duplicar `Junio 2026` y sobrescribir solo datos. Regla duradera: en hojas mensuales con fórmulas/formato —especialmente Control de Horas Propi— la plantilla es parte del dato; usar API oficial, duplicar mes anterior, tocar rangos mínimos, verificar, y jamás improvisar con pegado UI/Chrome salvo emergencia autorizada. Skill/protocolo: [[agentes/skills/propi-control-horas]].
...
- 2026-07-27: JR corrigió de nuevo el mismo patrón durante el viaje Florida: Geoffrey recomendó desayunos sin consultar la página canónica activa. Regla duradera reforzada: para cualquier sugerencia dependiente de ubicación —restaurantes, compras, logística, disponibilidad, rutas— revisar primero viajes activos en `wiki/viajes/` y la fecha actual; calendario es complemento, no fuente primaria de ubicación. No pedir “dónde está” si la página canónica ya lo dice.
