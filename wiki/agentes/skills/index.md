...
| [[propi-control-horas]] | aprobada | local | no aplica | Protocolo específico para Control de Horas Propi: duplicar mes anterior y sobrescribir solo datos; depende de Google Workspace MCP/API y requiere aprobación para writes/deletes. |
...
| WhatsApp | rechazada/revocada | [[wacli]] | bundled OpenClaw | Desconectado y desautorizado por JR el 2026-05-16; no usar. |
